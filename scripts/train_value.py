...
if __name__ == '__main__': 
    ...
    parser.add_argument("--frames", type=int, default=100*10**6,
                        help="number of frames of training (default: 100M)")
    ...
    if args.algo == "a2c":
        ...
        if args.strategy == "voi" or args.strategy == "random":
            ...
            algo = torch_ac.PPOAlgoOriginal(envs, acmodel, device, args.frames_per_proc, args.discount, args.lr, args.gae_lambda,
                                    args.entropy_coef, args.value_loss_coef, args.max_grad_norm, args.recurrence,
                                    args.optim_eps, args.clip_eps, args.epochs, args.batch_size, preprocess_obss)
    else:
